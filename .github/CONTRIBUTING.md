...
Thank you for your interest in contributing to **storage-service**! We welcome contributions from the community to help improve the project. Here are some guidelines to help you get started:
...
- **feat**: A new feature (e.g. `feat: add support for s3 storage`)
